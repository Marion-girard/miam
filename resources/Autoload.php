...
//     Lorsque l'on instancie une classe , la fonction 'inclusionAuto' de la classe
//     'Autoload' s'execute automatiquement et tout ce qu'il y a après le 'new'
//     (namespace\class) est envoyé directement en argument a la fonction 'inclusionAuto'
...
// 2 - str_replace() : fonction prédéfinie qui permet ici de remplacer les '\' par des '/' afin de définir le bon chemin.

// 3 - Chemin de la page web controller.php